...
% \doublespacing  % Double spacing for printout review

% Page margins
\usepackage[margin=1in]{geometry}
% \usepackage[margin=1.2cm]{geometry}  % for printout preview only
...
% For tables and figures (APA format)
\usepackage{booktabs}
\usepackage{graphicx}
\usepackage{caption}

% Reduce page number size
\usepackage{fancyhdr}
\pagestyle{plain}
\fancyhf{}
\fancyfoot[C]{\small\thepage}

% Hyperlinks (optional, for PDF)
\usepackage{hyperref}
\hypersetup{
    colorlinks=true,
    linkcolor=black,
...
\title{Privacy Governance-Driven Design of AI-Powered Elderly Safety Monitoring for Cambodia}
...
\author{
    ...
    \normalsize
    \url{monireach.tang@camtech.edu.kh}\\[12pt]
    \normalsize
    ...
    \normalsize
    \url{hul.seingheng@misti.gov.kh}\\[12pt]
    \normalsize
    \textbf{May Thu} \\[0pt]
    \normalsize
    Graduate School, Cambodia University of Technology and Science \\[0pt]
    \normalsize
    \url{may.thu@camtech.edu.kh}
}
...
Cambodia Socio-Economic Survey (CSES) household income data \parencite{CambodiaSocioEconomicSurvey} defines market segments. The 4th and 5th quintiles (middle-income and upper-middle-income urban households) earn \$870-\$1,622 per month, representing 40\% of urban households.
